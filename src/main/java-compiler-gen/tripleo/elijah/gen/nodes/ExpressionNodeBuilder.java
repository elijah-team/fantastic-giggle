...
public class ExpressionNodeBuilder {
	...
	public static IExpression binex(final TypeRef rt, final VariableReferenceImpl left, final ExpressionOperators middle, final IExpression right) {
	...
	@NotNull
	@Contract("_, _, _, _ -> new")
	public static IExpression binex(final TypeRef rt, final VariableReferenceImpl left, final ExpressionOperators middle, final TmpSSACtxNode right) { // todo wrong again
		// TODO Auto-generated method stub
		final ExpressionKind middle1 = Helpers.ExpressionOperatorToExpressionType(middle);
...
//	}
	...
	public static IdentExpression ident(final String string) {
		...
		return new IdentExpressionImpl(tripleo.elijah.util.Helpers.makeToken(string));
