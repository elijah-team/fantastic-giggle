...
public class DG_AliasStatement implements DG_Item {
	...
	private       DeferredObject<DG_Item, ResolveError, Void> _resolvePromise = new DeferredObject<>();
	private       boolean                                     _resolveStarted;
	private       DeduceTypes2                                __dt2;

	public DG_AliasStatement(final AliasStatementImpl aAliasStatement, final DeduceTypes2 aDt2) {
